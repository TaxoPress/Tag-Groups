/**
 * BLOCK: chatty-mango/chatty-mango-tpf-slider-button
 *
 *
...
const helpFeature =
  'toggle-post-filter/toggle-post-filter-slider-button-gutenberg-block/';
...
class tagGroupsPremiumDPFParameters extends Component {
  ...
  render() {
    ...
    const { button_class, button_text, theme, cover, source } = attributes;
      ...
      <div>
        ...
        {!cover && serverSideRender && (
          <div className='chatty-mango-not-active-all'>
            <button
              className={button_class + ' tg_dpf_slider_toggle_button'}
              autocomplete='off'
              type='button'
            >
              {button_text}
          ...
          <div className='chatty-mango-editor'>
            ...
            <div className='chatty-mango-editor-block'>
              <h3 className='chatty-mango-editor-title'>
                {__('Toggle Post Filter - Slider Button')}
              </h3>
 ...
 */
var cmTagGroupsTPFSLiderButtonBlock = registerBlockType(
  'chatty-mango/chatty-mango-tpf-slider-button',
  {
      title: __('Toggle Post Filter - Slider Button'),
      ...
      keywords: [__('post filter'), __('slider'), 'Chatty Mango'],
      transforms: {
        to: [
          {
            type: 'block',
            ...
            transform: function (attributes) {
              ...
              for (var attribute in attributes) {
                if (attributes.hasOwnProperty(attribute)) {
                  if (
                    ...
                    'source' !== attribute &&
                    cmTagGroupsTPFSLiderButtonBlock.attributes[attribute] &&
                    attributes[attribute] !==
                      cmTagGroupsTPFSLiderButtonBlock.attributes[attribute]
                        .default
                  ) {
              ...
              let text =
                '[tag_groups_tpf_slider_button ' + parameters.join(' ') + ']';
