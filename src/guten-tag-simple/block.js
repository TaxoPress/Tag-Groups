/**
 * BLOCK: chatty-mango-guten-tag-combined
 *
 *
 * @package     Tag Groups
...
const helpFeature = 'combined-tag-cloud/combined-tag-cloud-gutenberg-block/';

class tagGroupsPremiumSimpleCloudParameters extends Component {
        ...
        <div className='chatty-mango-inspector-control'>
          <PanelBody title={__('Tags and Taxonomies')} initialOpen={false}>
            ...
            <RangeControl
              ...
              value={smallest !== undefined ? Number(smallest) : 22}
              onChange={(smallest) => {
            ...
            <RangeControl
              ...
              value={largest !== undefined ? Number(largest) : 12}
              onChange={(largest) => {
      ...
      <div>
        ...
        {!cover && serverSideRender && (
          <TagGroupsServerSideRender
            block='chatty-mango/tag-groups-premium-cloud-combined'
 ...
 */
var cmTagGroupsSimpleBlock = registerBlockType(
  'chatty-mango/tag-groups-premium-cloud-combined',
  {
    title: __('Tag Cloud'),
    icon: 'tagcloud', // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
    category: 'chatty-mango',
    description: __(
      'Show your tags in a tag cloud that combines multiple groups.'
    ),
    keywords: [__('combined'), __('tag cloud'), 'Chatty Mango'],
    html: false,
    transforms: {
      to: [
        {
          ...
          transform: function (attributes) {
            ...
            for (var attribute in attributes) {
              if (attributes.hasOwnProperty(attribute)) {
                if (
                  ...
                  'source' !== attribute &&
                  cmTagGroupsSimpleBlock.attributes[attribute] &&
                  attributes[attribute] !==
                    cmTagGroupsSimpleBlock.attributes[attribute].default
                ) {
            ...
            let text = '[tag_groups_simple_cloud ' + parameters.join(' ') + ']';
     ...
     */
    edit: tagGroupsPremiumSimpleCloudParameters,
