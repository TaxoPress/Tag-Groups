...
if ( !class_exists( 'TagGroups_Admin' ) ) {
    class TagGroups_Admin
    {
         ...
         * @return void
         */
        static function remove_submenus()
        {
            global  $tag_groups_premium_fs_sdk ;
         ...
         * @return string
         */
        static function add_admin_footer_rating_text( $text )
        {
         ...
         * @return string
         */
        static function add_admin_footer_tooltip_script( $text )
        {
            $screen = get_current_screen();
            if ( empty($_GET['page']) || strpos( $_GET['page'], 'tag-groups' ) !== 0 ) {
        ...
        {
            global  $pagenow, $tag_groups_premium_fs_sdk, $tag_group_groups ;
            if ( 'edit.php' != $pagenow ) {
                return $query;
            }
