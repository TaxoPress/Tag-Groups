<div class="tg_settings_tabs_content">
  ...
  if ( ! $referer || strpos( $referer, site_url() ) !== 0 ) {
      $referer = site_url(); // Default to site URL if invalid
  }
  $clean_url = remove_query_arg( 'process-tasks', $referer );
  ?>
  ...
  <div id="tag_groups_tasks_final_words_error" style="display: none;">
    ...
    <span>
      <a class="button button-primary" href="<?php echo esc_url($clean_url); ?>"><?php _e( 'Continue', 'tag-groups' ) ?></a>
    </span>
  </div>
