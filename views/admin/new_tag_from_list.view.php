<div class="form-field">
  ...
  <select id="term-group" name="term-group" autocomplete="off">
    ...
    <?php foreach ($term_groups as $term_group) : ?>
      <option value="<?php echo $term_group['term_group']; ?>" <?php if (in_array($term_group['term_group'], $new_tag_initial_groups)) :
            ?> selected="selected"<?php 
                     endif; ?>><?php echo htmlentities($term_group['label'], ENT_QUOTES, "UTF-8"); ?></option>
    <?php endforeach; ?>
  </select>
  <script>
