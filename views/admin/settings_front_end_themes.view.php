      ...
      <div style="min-width:500px;padding-right:20px;">
        ...
        <ul>
          ...
          <li>
            ...
            <?php if ($tag_group_theme && ! in_array($tag_group_theme, $default_themes)) :
                ?> checked<?php 
            endif;?>
            />&nbsp;
      ...
      <div style="min-width: 500px;">
        ...
        <ul>
          <li>
            ...
            <?php if ($tag_group_enqueue_jquery) :
                ?> checked<?php 
            endif;?>/>&nbsp;
