...
<div class="tg-onboarding-container">
  <h3><?php printf(esc_html__('Welcome to %s!', 'tag-groups'), esc_html($title)) ?></h3>
  ...
  <div id="tag_groups_onboarding_accordion">
    ...
    <div style="display:none;">
      <ol>
        <li><?php printf(esc_html__('Go to the <span class="dashicons dashicons-tag"></span>&nbsp;Tag Groups <a %s>taxonomy settings</a> and <b>select the taxonomy</b> (tag type) of your tags. In most cases just leave the default: Tags (post_tag).', 'tag-groups'), 'href="' . esc_url($settings_taxonomy_link) . '" target="_blank"') ?></li>
        <li><?php _e('Go to the tag groups admin page and <b>create some groups</b>.', 'tag-groups') ?> <?php printf(esc_html__('You can find these pages listed on your <a %s>Tag Groups home page</a>.', 'tag-groups'), 'href="' . esc_url($settings_home_link) . '" target="_blank"') ?></li>
