...
<div id="<?php echo $div_id ?>" <?php if (! empty($div_class)) :
    ...
    ?>style="margin: 0 0 0 -5000px !important; width:<?php echo $slider_width ?>px; max-width:100%;"<?php
         endif;?>>
  <div id="tg_filter_box_toggle_close_button" class="tg_dpf_slider_toggle_button tg_pointer tg_tpf_slider_left_close_button" title="<?php _e('close', 'tag-groups') ?>"><span class="dashicons dashicons-no-alt"></span></div>
  <div id="tg_filter_box_toggle_menu" class="tg_tpf_slider_left_menu" role="search">
    <?php if ($text_search) :
        ?>
