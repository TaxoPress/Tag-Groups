...
<div id="<?php echo $div_id ?>" <?php if (!empty($div_class)) :
  ...
  <div id="tg_filter_box_toggle_menu" role="search">
    <?php if ($text_search) :
        ?>
      ...
      <div id="tg_group_dpf_toggle_group_container_<?php echo $toggle_group['group_id'] ?>" class="tg_group_dpf_toggle_group_container">
        ...
        <div id="tg_group_dpf_toggle_term_container_<?php echo $toggle_group['group_id'] ?>" class="tg_group_dpf_toggle_term_container">
          <?php foreach ($toggle_group['terms'] as $term) :
                ?>
          <div data-groupid="<?php echo $toggle_group['group_id'] ?>" data-termid="<?php echo $term->term_id ?>">
            <label class="tg_pointer" tabindex="<?php echo $tabindex ?>" data-groupid="<?php echo $toggle_group['group_id'] ?>" data-termid="<?php echo $term->term_id ?>" aria-hidden="true" for="tg_group_dpf_toggle_term_<?php echo $toggle_group['group_id'] ?>_<?php echo $term->term_id ?>">
                <?php echo $term->name ?>
            </label>
